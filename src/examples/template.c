 ...
 *
 * Abstract:
 * 	Template for implementing a custom model compatible with the VeriStand Model Framework.
...
#define readParam rtParameter[READSIDE]
 ...
 /*========================================================================*
  ...
  + When a model has parameters of the form: "modelname/parameter"
		these model parameters are considered global parameters (target scoped) in VeriStand
  + When a model has parameters of the form: "modelname/block/paramter" 
		these model parameters are NOT considered global parameters (model scoped) in VeriStand
