 ...
 *
 * Abstract:
 *	Function prototypes and type definitions to the VeriStand Model Framework
 *
 *========================================================================*/
...
#if defined (kNIOSLinux) || _MSC_VER > 1500
	/* Linux or MSVC10+ */
	#include <stdint.h>
#else
	/* MSVC9 and earlier */
